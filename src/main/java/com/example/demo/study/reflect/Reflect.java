package com.example.demo.study.reflect;
...
public class Reflect {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class<?> demoOfReflectClass2 = Class.forName("com.example.demo.study.reflect.DemoOfReflect");
        // 3 通过实例对象获取
        DemoOfReflect demoOfReflect = new DemoOfReflect();
        Class<? extends DemoOfReflect> demoOfReflectClass3 = demoOfReflect.getClass();
        // 4 通过类加载器传入路径 不会初始化
        Class<?> demoOfReflectClass4 = ClassLoader.getSystemClassLoader().loadClass("com.example.demo.study.reflect.DemoOfReflect");
    }
}
